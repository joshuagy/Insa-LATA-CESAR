...
class Controls:
  def __init__(self, screen, font, currentSpeed, increaseSpeed, decreaseSpeed):
    self.screen = screen
    self.font = font
  ...
  def generateListOfButtons(self):
    ...
    self.clear_land_button = ButtonCtrlPnl(self, clear_land,"Clear land", self.screenWidth-99 - self.originX, 301 - self.originY, "image/C3/paneling_00131.png", "image/C3/paneling_00132.png","image/C3/paneling_00133.png")
    listOfButtons.append(self.clear_land_button)

    self.build_roads_button = ButtonCtrlPnl(self, build_roads,"Build roads", self.screenWidth - 49 - self.originX ,301 - self.originY,"image/C3/paneling_00135.png","image/C3/paneling_00136.png","image/C3/paneling_00137.png")
    listOfButtons.append(self.build_roads_button)
    
    self.build_housing_button = ButtonCtrlPnl(self, build_housing, "Build housing", self.screenWidth-149 - self.originX, 301 - self.originY,"image/C3/paneling_00123.png","image/C3/paneling_00124.png","image/C3/paneling_00125.png")
    listOfButtons.append(self.build_housing_button)

    self.water_related_structures = ButtonCtrlPnl(self, build_water_related_structures, "Water related structure", self.screenWidth - 149 - self.originX, 337 - self.originY,"image/C3/paneling_00127.png","image/C3/paneling_00128.png","image/C3/paneling_00129.png")
    ...
    self.engineering_structures = ButtonCtrlPnl(self, build_engineer_post, "Engineering function", self.screenWidth - 149 - self.originX,409 - self.originY,"image/C3/paneling_00167.png","image/C3/paneling_00168.png","image/C3/paneling_00169.png")
    listOfButtons.append(self.engineering_structures)

    self.security_structures = ButtonCtrlPnl(self, build_prefecture,"Security Structures", self.screenWidth - 99 - self.originX,409 - self.originY,"image/C3/paneling_00159.png","image/C3/paneling_00160.png","image/C3/paneling_00161.png")
    ...
    self.variable_speed_up = ButtonSpeed(self, self.increaseSpeed, "Game speed up", self.screenWidth - 149 - self.originX, 490 - self.originY, "image/UI/menu/variable_speed/paneling_00247.png","image/UI/menu/variable_speed/paneling_00248.png","image/UI/menu/variable_speed/paneling_00249.png")
    listOfButtons.append(self.variable_speed_up)

    self.variable_speed_down = ButtonSpeed(self, self.decreaseSpeed, "Game speed down", self.screenWidth + self.variable_speed_up.dim[0] - 145 - self.originX, 490 - self.originY, "image/UI/menu/variable_speed/paneling_00251.png","image/UI/menu/variable_speed/paneling_00252.png","image/UI/menu/variable_speed/paneling_00253.png")
